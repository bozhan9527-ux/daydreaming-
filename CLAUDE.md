...
## 專案概述
一款「反差萌」放置型手機遊戲。玩家無聊時點一下勇者,隨機觸發特殊畫面(吐槽/彩蛋);
玩家不玩的時候,勇者自己在背景打怪升級。核心體驗 = 「打開就有驚喜,不開也在成長」。
...
- **畫布尺寸**:40×48(勇者本體),純程式產生(色碼網格 + Canvas/View 渲染),不是點陣圖檔
- **調色盤**:厭世莫蘭迪(低飽和霧灰色系)
  ```
...
- **裝備插槽**(10 個,由後到前疊層):
  ...
  - 武器/盾牌插槽左右各保留 6px(40 寬畫布下),體型變化不可佔用此區域
