...
import { PHYSICAL_MELEE_JOB_EGGS } from './jobEggs/physicalMelee';
import { PHYSICAL_RANGED_JOB_EGGS } from './jobEggs/physicalRanged';
import { PHYSICAL_SUPPORT_JOB_EGGS } from './jobEggs/physicalSupport';
...
const ALL_JOB_EGGS = [...MAGIC_MELEE_JOB_EGGS, ...PHYSICAL_SUPPORT_JOB_EGGS, ...PHYSICAL_RANGED_JOB_EGGS, ...PHYSICAL_MELEE_JOB_EGGS];
